...
func NewTensor(size []int) StoredTensor{
  rank:=len(size);
  switch {
    case rank==0: return NewTensor0();
    case rank==1: return NewTensor1(size);
    case rank==2: return NewTensor2(size);
    case rank==3: return NewTensor3(size);
    case rank==4: return NewTensor4(size);
    case rank==5: return NewTensor5(size);
  }
  //default:
