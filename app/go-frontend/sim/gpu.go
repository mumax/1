...
/**
 * This single file intefaces all the relevant CUDA func(d Device) tions with go
 * It only wraps the func(d Device) tions, higher level constructs and assetions
...
func(d Device)  torque(m, h unsafe.Pointer, alpha, dtGilbert float, N int){
  C.gpu_torque((*_C_float)(m), (*_C_float)(h), _C_float(alpha), _C_float(dtGilbert), _C_int(N))
}


func(d Device)  normalize(m unsafe.Pointer, N int){
  C.gpu_normalize_uniform((*_C_float)(m), _C_int(N))
}

func(d Device)  normalizeMap(m, normMap unsafe.Pointer, N int){
  C.gpu_normalize_map((*_C_float)(m), (*_C_float)(normMap), _C_int(N))
}


func(d Device)  eulerStage(m, torque unsafe.Pointer, N int){
...
func(d Device)  kernelMul(mx, my, mz, kxx, kyy, kzz, kyz, kxz, kxy unsafe.Pointer, nRealNumbers int){
...
func(d Device)  copyPad(source, dest unsafe.Pointer, sourceSize, destSize []int){
...
func(d Device)  copyUnpad(source, dest unsafe.Pointer, sourceSize, destSize []int){
...
func(d Device)  newFFTPlan(dataSize, logicSize []int) unsafe.Pointer{
...
/// unsafe FFT
func(d Device)  fftForward(plan unsafe.Pointer, in, out unsafe.Pointer){
  C.gpuFFT3dPlan_forward_unsafe((*_C_gpuFFT3dPlan)(plan), (*_C_float)(in), (*_C_float)(out))
}


/// unsafe FFT
func(d Device)  fftInverse(plan unsafe.Pointer, in, out unsafe.Pointer){
  C.gpuFFT3dPlan_inverse_unsafe((*_C_gpuFFT3dPlan)(plan), (*_C_float)(in), (*_C_float)(out))
}


// func(d Device)  (fft *FFT) Normalization() int{
...
// func(d Device)  PadToStride(nFloats int) int{
...
func(d Device)  overrideStride(nFloats int){
...
func(d Device)  zero(data unsafe.Pointer, nFloats int){
