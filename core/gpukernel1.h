 ...
 */
void gpu_init_and_FFT_Greens_kernel_elements_1(tensor *dev_kernel,  								///< rank 2 tensor; rank 0: xx, xy, xz, yy, yz, zz parts of symmetrical Greens tensor, rank 1: all data of a Greens kernel component contiguously
 ...
 */
__global__ void _gpu_init_Greens_kernel_elements_1(float *dev_temp, 			///< pointer to the temporary memory space on the device to store all elements of a given Greens tensor component
 ...
 */
__device__ float _gpu_get_Greens_element_1(int Nkernel_X, 					///< Non-strided size of the kernel data (x-direction)
                                           int Nkernel_Y, 					///< Non-strided size of the kernel data (y-direction)
                                           int Nkernel_Z, 					///< Non-strided size of the kernel data (z-direction)
                                           int co1, 								///< co1 and co2 define the requested Greens tensor component: e.g. co1=0, co2=1 defines gxy
                                           int co2, 								///< co1 and co2 define the requested Greens tensor component: e.g. co1=0, co2=1 defines gxy
 ...
 */
__global__ void _gpu_extract_real_parts_1(float *dev_kernel_array, 	///< rank 2 tensor; rank 0: xx, xy, xz, yy, yz, zz parts of symmetrical Greens tensor, rank 1: all data of a Greens kernel component contiguously
 ...
 */
void initialize_Gauss_quadrature_on_gpu_1(float *dev_qd_W_10,  ///< float array (10 floats) containing the 10 Gauss quadrature weights (on device)
                                          float *dev_qd_P_10,  ///< float array (30 floats) containing the 10 Gauss quadrature points for X, Y and Z contiguously (on device)
 ...
 */
void get_Quad_Points_1(float *gaussQP, 			///< float array containing the requested Gauss quadrature points
