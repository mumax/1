 ...
 */
void gpu_init_and_FFT_Greens_kernel_elements(tensor *dev_kernel,        ///< rank 2 tensor; rank 0: yy, yz, zz parts of symmetrical Greens tensor, rank 1: all data of a Greens kernel component contiguously
 ...
 */
__device__ float _gpu_get_Greens_element(int Nkernel_Y,           ///< Non-strided size of the kernel data (y-direction)
                                         int Nkernel_Z,           ///< Non-strided size of the kernel data (z-direction)
                                         int exchInConv_Y,        ///< 1 if exchange is to be included in the y-direction
                                         int exchInConv_Z,        ///< 1 if exchange is to be included in the z-direction
                                         int co1,                 ///< co1 and co2 define the requested Greens tensor component: e.g. co1=0, co2=1 defines gxy
 ...
 */
__global__ void _gpu_extract_real_parts(float *dev_kernel_array,  ///< rank 2 tensor; rank 0: yy, yz, zz parts of symmetrical Greens tensor, rank 1: all data of a Greens kernel component contiguously
