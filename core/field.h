...
fieldplan *new_fieldplan(param* params,     ///< parameters describe which contributions to take into account
                         tensor* kernel     ///< convolution kernel for the demag field (or anything else). NULL means we do not need a convolution (unlikely though)
                         );
/**
 * Creates a new fieldplan (ben)
 */
fieldplan *new_fieldplan_ben(param* params,     ///< parameters describe which contributions to take into account
