 ...
 *
 */
#ifndef gpu_local_contr3_h
#define gpu_local_contr3_h
 ...
 */
void gpu_add_local_fields (float* m, float* h, int N, int Hext_uniform, float *Hext, int anisType, float *anisK, float *anisAxes);


/**
 * Adds the local contributions to the effective field and to the energy density.
 */
void gpu_add_local_fields_H_and_phi (float* m, float* h, float *phi, int N, int Hext_uniform, float* Hext, int anisType, float* anisK, float* anisAxes);
