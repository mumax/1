 ...
 * of fftw. The Kernel components are Fourier transformed and only the real parts are stored 
 ...
 */
void cpu_kernel_micromag2d(int *kernelSize,     ///< Non-strided size of the kernel data
 ...
 */
void cpu_init_and_FFT_Greens_kernel_elements_micromag2d(float *dev_kernel,  			///< float array: list of rank 2 tensor; rank 0: xx, xy, xz, yy, yz, zz parts of symmetrical Greens tensor, rank 1: all data of a Greens kernel component contiguously
 ...
 */
void _cpu_init_Greens_kernel_elements_micromag2d(float *dev_temp, 		 ///< pointer to the temporary memory space on the device to store all elements of a given Greens tensor component
 ...
 */
void _cpu_extract_real_parts_micromag2d(float *dev_kernel_array, 	///< pointer to the first kernel element of the considered tensor element
