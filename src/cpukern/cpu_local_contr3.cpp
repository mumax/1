...
typedef struct{
  ...
  int N;
}cpu_add_uniform_Hext_arg;

void cpu_add_uniform_Hext_t(int id){
  
  cpu_add_uniform_Hext_arg *arg = (cpu_add_uniform_Hext_arg *) func_arg;
...
void cpu_add_uniform_Hext(float* hx, float* hy, float* hz,
                          float hext_x, float hext_y, float hext_z,
                          int N){

  cpu_add_uniform_Hext_arg args;
  args.hx = hx;
  args.hy = hy;
  args.hz = hz;
  args.hext_x = hext_x;
  ...
  thread_Wrapper(cpu_add_uniform_Hext_t);
...
void cpu_add_non_uniform_Hext_t(int id){
  
  cpu_add_non_uniform_Hext_arg *arg = (cpu_add_non_uniform_Hext_arg *) func_arg;
...
void cpu_add_non_uniform_Hext(float *hx, float *hy, float *hz,
  ...
  thread_Wrapper(cpu_add_non_uniform_Hext_t);
...
typedef struct{
  ...
  int N;
}cpu_add_uniaxial_anis_uniform_Hext_arg;

void cpu_add_uniaxial_anis_uniform_Hext_t(int id){
  
  cpu_add_uniaxial_anis_uniform_Hext_arg *arg = (cpu_add_uniaxial_anis_uniform_Hext_arg *) func_arg;
...
void cpu_add_uniaxial_anis_non_uniform_Hext_t(int id){
  
  cpu_add_uniaxial_anis_non_uniform_Hext_arg *arg = (cpu_add_uniaxial_anis_non_uniform_Hext_arg *) func_arg;
...
typedef struct{
  ...
  int N;
}cpu_add_cubic_anis_uniform_Hext_arg;

void cpu_add_cubic_anis_uniform_Hext_t(int id){
  
  cpu_add_cubic_anis_uniform_Hext_arg *arg = (cpu_add_cubic_anis_uniform_Hext_arg *) func_arg;
...
void cpu_add_cubic_anis_uniform_Hext(float *mx, float *my, float *mz, float* hx, float* hy, float* hz,
  ...
  cpu_add_cubic_anis_uniform_Hext_arg args;
  args.mx = mx;
  args.my = my;
  args.mz = mz;
  args.hx = hx;
  ...
  thread_Wrapper(cpu_add_cubic_anis_uniform_Hext_t);
...
void cpu_add_cubic_anis_non_uniform_Hext_t(int id){
  
  cpu_add_cubic_anis_non_uniform_Hext_arg *arg = (cpu_add_cubic_anis_non_uniform_Hext_arg *) func_arg;
...
void cpu_add_cubic_anis_non_uniform_Hext(float *mx, float *my, float *mz, float* hx, float* hy, float* hz,
  ...
  cpu_add_cubic_anis_non_uniform_Hext_arg args;
  args.mx = mx;
  args.my = my;
  args.mz = mz;
  args.hx = hx;
  ...
  thread_Wrapper(cpu_add_cubic_anis_non_uniform_Hext_t);
...
typedef struct{
  ...
  float hext_x, hext_y, hext_z;
  int N;
}cpu_add_uniform_Hext_and_phi_arg;

void cpu_add_uniform_Hext_and_phi_t(int id){
  
  cpu_add_uniform_Hext_and_phi_arg *arg = (cpu_add_uniform_Hext_and_phi_arg *) func_arg;
...
void cpu_add_uniform_Hext_and_phi(float *mx, float *my, float *mz,
                                  float *hx, float *hy, float *hz, float *phi,
                                  float hext_x, float hext_y, float hext_z,
                                  int N){

  cpu_add_uniform_Hext_and_phi_arg args;
  args.mx = mx;
  args.my = my;
  args.mz = mz;
  args.hx = hx;
  ...
  thread_Wrapper(cpu_add_uniform_Hext_and_phi_t);
...
void cpu_add_non_uniform_Hext_and_phi_t(int id){
  
  cpu_add_non_uniform_Hext_and_phi_arg *arg = (cpu_add_non_uniform_Hext_and_phi_arg *) func_arg;
...
void cpu_add_non_uniform_Hext_and_phi(float *mx, float *my, float *mz,
  ...
  thread_Wrapper(cpu_add_non_uniform_Hext_and_phi_t);
...
typedef struct{
  ...
  float hext_x, hext_y, hext_z, anisK, U0, U1, U2;
  int N;
}cpu_add_uniaxial_anis_uniform_Hext_and_phi_arg;
...
void cpu_uniaxial_anis_uniform_Hext_and_phi(float *mx, float *my, float *mz, float* hx, float* hy, float* hz, float *phi,
  ...
  cpu_add_uniaxial_anis_uniform_Hext_and_phi_arg args;
  args.mx = mx;
  args.my = my;
  args.mz = mz;
  args.hx = hx;
  ...
  thread_Wrapper(cpu_add_uniaxial_anis_uniform_Hext_and_phi_t);
...
void cpu_add_uniaxial_anis_non_uniform_Hext_and_phi_t(int id){
  
  cpu_add_uniaxial_anis_non_uniform_Hext_and_phi_arg *arg = (cpu_add_uniaxial_anis_non_uniform_Hext_and_phi_arg *) func_arg;
...
void cpu_uniaxial_anis_non_uniform_Hext_and_phi(float *mx, float *my, float *mz, float* hx, float* hy, float* hz, float *phi,
  ...
  thread_Wrapper(cpu_add_uniaxial_anis_non_uniform_Hext_and_phi_t);
...
typedef struct{
  ...
  float hext_x, hext_y, hext_z, K0, K1, U0_0, U0_1, U0_2, U1_0, U1_1, U1_2, U2_0, U2_1, U2_2;
  int N;
}cpu_add_cubic_anis_uniform_Hext_and_phi_arg;

void cpu_add_cubic_anis_uniform_Hext_and_phi_t(int id){
  
  cpu_add_cubic_anis_uniform_Hext_and_phi_arg *arg = (cpu_add_cubic_anis_uniform_Hext_and_phi_arg *) func_arg;
...
void cpu_add_cubic_anis_uniform_Hext_and_phi(float *mx, float *my, float *mz, float* hx, float* hy, float* hz, float *phi,
                                             float hext_x, float hext_y, float hext_z, float K0, float K1, 
                                             float U0_0, float U0_1, float U0_2,
                                             float U1_0, float U1_1, float U1_2,
                                             float U2_0, float U2_1, float U2_2, 
  ...
  cpu_add_cubic_anis_uniform_Hext_and_phi_arg args;
  args.mx = mx;
  args.my = my;
  args.mz = mz;
  args.hx = hx;
  ...
  thread_Wrapper(cpu_add_cubic_anis_uniform_Hext_and_phi_t);
...
void cpu_add_cubic_anis_non_uniform_Hext_and_phi_t(int id){
  
  cpu_add_cubic_anis_non_uniform_Hext_and_phi_arg *arg = (cpu_add_cubic_anis_non_uniform_Hext_and_phi_arg *) func_arg;
...
void cpu_add_cubic_anis_non_uniform_Hext_and_phi(float *mx, float *my, float *mz, float* hx, float* hy, float* hz, float *phi,
  ...
  cpu_add_cubic_anis_non_uniform_Hext_and_phi_arg args;
  args.mx = mx;
  args.my = my;
  args.mz = mz;
  args.hx = hx;
  ...
  thread_Wrapper(cpu_add_cubic_anis_non_uniform_Hext_and_phi_t);
