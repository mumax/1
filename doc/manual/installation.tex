...
Otherwise, you can install the driver located in \file{dep/cuda}. First, make sure you have the necessary build tools installed on your system:
...
\shell{cd \prog/dep/cuda\\
sudo ./devdriver\_3.1\_linux\_64\_256.40.run}
